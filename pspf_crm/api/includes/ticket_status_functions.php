...
function getStatusIcons($status) {
    $icons = [
        ...
        'Pending Feedback' => 'bi-chat-dots',
        'Pending Customer' => 'bi-hourglass-split',
        'Pending Vendor'   => 'bi-hourglass-split',
...
function getStatusColor($status) {
    $colors = [
        ...
        'Reopened'         => 'primary',
        'Escalated'        => 'danger',
        'Pending Feedback' => 'secondary',
        'Pending Customer' => 'secondary',
        'Pending Vendor'   => 'secondary',
        'On Hold'          => 'secondary',
        // lowercase variants
        'open'             => 'warning text-dark',
        'in progress'      => 'info text-dark',
...
function getChangeReason($ticketId) {
    ...
    $stmt = $conn->prepare("
        SELECT new_status, change_reason, changed_by, change_date
        FROM ticket_status_logs
        WHERE ticket_id = ?
