...
<nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(135deg, var(--pspf-primary) 0%, var(--pspf-primary-dark) 100%); padding: 0.5rem 1rem; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
		 ...
		 <!-- Vehicle Booking Tab-->
                <li class="nav-item">
                    <a class="nav-link" href="../../vehicle_booking/login.php">
		...
		<li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi bi-ticket-perforated me-1"></i> Requests
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="http://hpkprd:8080" target="_blank"><i class="bi bi-folder2-open me-2"></i>Member Files</a></li>
                        <li><a class="dropdown-item" href="/pspf_crm/api/it_access/index.php"><i class="bi bi-pc-display-horizontal me-2"></i>IT Access Form</a></li>
                    </ul>
                </li>		
