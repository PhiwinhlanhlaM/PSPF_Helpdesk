...
// =====================================================
// FEEDBACK TOKEN PREP (generated on close, sent as courtesy email)
// =====================================================
...
try {
    ...
    // =====================================================
    // HANDLE CLOSURE (LOG + OPTIONAL FEEDBACK TOKEN)
    // =====================================================
    if ($newLower === 'closed') {
        ...
        $feedbackLink = "http://192.168.1.14:8080/pspf_crm/api/ticket/feedback.php?token=" . $token;
    }
...
try {
    ...
    if ($ticketInfo) {
        ...
        if ($newLower === 'closed') {
            ...
            $body = "
                <h3>Hello,</h3>
                <p>Your ticket <strong>#$ticketId</strong> ({$ticketInfo['title']}) has been closed.</p>
                <p><strong>Closure Details:</strong><br>" . nl2br(htmlspecialchars($details)) . "</p>
            ";
            if ($feedbackLink) {
                $body .= "
                <hr>
                <h4>Optional: Rate our service</h4>
                <p>We'd appreciate your feedback to help us improve.</p>
