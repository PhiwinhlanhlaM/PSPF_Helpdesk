...
// ---- SavedSignaturePanel ----
// Auto-applied panel: saved signature is already active; user can change or remove it.
function SavedSignaturePanel({ saved, onDrawNew }) {
  return (
    <div className="sigpad">
      <div style={{
        padding: "12px 14px", background: "var(--green-50,#f0fdf4)",
        border: "1.5px solid var(--green-300,#86efac)", borderRadius: 8,
      }}>
        <div className="row gap-2" style={{ alignItems: "center", marginBottom: 8 }}>
          <Icon name="check-circle" size={14} style={{ color: "var(--green-700)" }}/>
          <strong style={{ fontSize: 12.5, color: "var(--green-800,#166534)" }}>Using your saved signature</strong>
        </div>
        <div style={{ background: "white", borderRadius: 6, padding: 8, border: "1px solid var(--ink-100)", display: "inline-block", marginBottom: 10 }}>
        ...
        <div className="row gap-2">
          <button type="button" className="btn btn-ghost btn-sm" onClick={onDrawNew}>
            <Icon name="pen" size={12}/> Change signature
          </button>
...
function SignaturePad({ onChange, height = 200 }) {
  ...
  function drawNew() {
    setShowSaved(false);
    pushChange(null); // clear current value until they draw/upload
  }
