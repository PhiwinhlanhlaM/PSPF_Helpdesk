...
<div class="container mt-4">
    <h3 class="mb-3">Welcome, <?= $_SESSION['name'] ?> (Driver)</h3>
    <a href="../vehicle_booking/logout.php" class="btn btn-secondary btn-sm float-end">Logout</a>
    <h4 class="mt-5 mb-3 text-primary">Pending Requests</h4>
    ...
    <h4 class="mt-5 mb-3 text-success">Approved by You (Awaiting Supervisor)</h4>
